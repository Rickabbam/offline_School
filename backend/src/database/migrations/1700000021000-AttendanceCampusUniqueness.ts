...
export class AttendanceCampusUniqueness1700000021000
  implements MigrationInterface
{
  name = "AttendanceCampusUniqueness1700000021000";
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      ...
      WHERE older.id <> newer.id
        ...
        AND COALESCE(older.campus_id, '00000000-0000-0000-0000-000000000000'::uuid)
          = COALESCE(newer.campus_id, '00000000-0000-0000-0000-000000000000'::uuid)
    ...
    await queryRunner.query(`
      CREATE UNIQUE INDEX IF NOT EXISTS idx_attendance_student_class_date_campus_active
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      DROP INDEX IF EXISTS idx_attendance_student_class_date_campus_active
    `);
