...
class Students extends Table {
  ...
  TextColumn get firstName => text().named('first_name').withLength(min: 1, max: 100)();
  TextColumn get middleName => text().named('middle_name').nullable()();
  TextColumn get lastName => text().named('last_name').withLength(min: 1, max: 100)();
...
class Guardians extends Table {
  ...
  TextColumn get relationship => text().withDefault(const Constant('guardian'))();
